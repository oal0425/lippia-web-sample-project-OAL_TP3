...
public class MyAccountConstants {
    ...
    public static final String LOGOUT_BUTTON = "xpath://*[@id='page-36']/div/div[1]/div/p[1]/a";

    public static final String CUSTOMER_LOGIN = "xpath://*[@id='customer_login']";
    ...
    public static final String REGISTER_ERROR_MESSAGE_PASSWORD_XPATH = "xpath://*[contains(text(), 'Please enter an account password')]";
